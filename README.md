...
[![Stack](https://skillicons.dev/icons?i=typescript,react,nextjs,tailwind,javascript,html,css,styledcomponents,nodejs,express,nestjs,postgres,prisma,flutter,kotlin,git,github,figma,vercel,docker&perline=10)](https://skillicons.dev)
